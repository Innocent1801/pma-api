...
module.exports.sendPaymentNotification = async (id, uuid) => {
  console.log("Check");

  const message = {
    from: process.env.EMAIL_USER,
    to: process.env.EMAIL_USER,
    subject: "Proof Upload Notification",
        ...
        * {
        ...
        <table style="font-family:'Lato',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
          ...
          <div style="line-height: 140%; text-align: left; word-wrap: break-word;">
            <p style="line-height: 140%; text-align: center; font-size: 14px;"><span style="color: #ffffff; font-size: 14px; line-height: 19.6px;"><span style="font-size: 28px; line-height: 39.2px;">New Package Notification</span></span></p>
          </div>
        ...
        <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 18px; line-height: 25.2px; color: #666666;">We have sent you this email to notify you that this user ${uuid} has just uploaded a payment proof. Kindly review.</span></p>
        <p style="font-size: 14px; line-height: 140%;"> </p>
        <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 18px; line-height: 25.2px; color: #666666;">Please follow the link below to see payment details: </span></p>
          </div>
        ...
        <div align="left">
          <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;font-family:'Lato',sans-serif;"><tr><td style="font-family:'Lato',sans-serif;" align="left"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://ctpayadmin.mygoldenpay.com/payment-proof/${id}" style="height:47px; v-text-anchor:middle; width:165px;" arcsize="2%" stroke="f" fillcolor="#18163a"><w:anchorlock/><center style="color:#FFFFFF;font-family:'Lato',sans-serif;"><![endif]-->
            <a href="https://ctpayadmin.mygoldenpay.com/payment-proof/${id}" target="_blank" style="box-sizing: border-box;display: inline-block;font-family:'Lato',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #18163a; border-radius: 1px;-webkit-border-radius: 1px; -moz-border-radius: 1px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;">
              <span style="display:block;padding:15px 40px;line-height:120%;">View Payment</span>
            </a>
